...
/* stdout */
#define SHOW_INSERT_SYMTAB(sym) printf("add new symbol %s\n", sym)
#define SHOW_OPEN_SCOPE() puts("create a scope")
#define SHOW_CLOSE_SCOPE() puts("close a scope")
...
#define SYMTAB_ENTRY_FORMAT "|%-12s|   %-4d|%-48s|\n"
